import Z85 from '../../src/Encoders/Z85';
import {
...
test('Should encode and decode its own sourcecode using Z85 encoding', () => {
    const encodedString = encoder.encode(rwt);
    expect(encoder.decode(encodedString)).toEqual(rwt);
});
